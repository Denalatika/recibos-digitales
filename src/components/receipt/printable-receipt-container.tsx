...
export function PrintableReceiptContainer({
  ...
  // 'dual' = 2 recibos por hoja vertical (media carta c/u)
  // 'single' = 1 recibo por hoja horizontal (carta completa)
  ...
  const handleDownloadPdf = async () => {
    try {
      ...
      await downloadReceiptAsPdf({
        ...
        filename: `RECIBO_${receipt.company?.folio_prefix || 'DOC'}_${receipt.folio}_${printLayout === 'dual' ? 'DUAL' : 'FULL'}.pdf`,
        orientation: printLayout === 'dual' ? 'portrait' : 'landscape',
      });
    } catch (err) {
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="inline-flex rounded-lg border border-slate-200 p-0.5 bg-slate-100">
              ...
              >
                ...
                <span>1 por Hoja (Carta Horizontal)</span>
              </button>
            </div>
          </div>
